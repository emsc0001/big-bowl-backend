...
public class InitData implements CommandLineRunner {
    ...
    public InitData(BowlinLaneRepository bowlingLaneRepository, ProductRepository productRepository, DinnerTableRepository dinnerTableRepository, BookingActivityRepository bookingActivityRepository, AirHockeyTableRepository airHockeyTableRepository, BookingRepository bookingRepository) {
    ...
    public void run(String... args) throws Exception {
        ...
        // Create some booking activities
